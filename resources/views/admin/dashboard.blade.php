<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ auth()->user()->isSuperAdmin() ? __('SuperAdmin Dashboard') : __('Admin Dashboard') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                @if(auth()->user()->isSuperAdmin())
                                    You have full system access. Here's your complete system overview.
                                @else
                                    Here's your employee management overview for employees you've created.
                                @endif
                            </p>
                        </div>
            ...
            <!-- Access Level Info for Regular Admin -->
            @if(auth()->user()->isRegularAdmin())
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <div class="flex">
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-blue-800">Your Access Level</h3>
                            <p class="text-sm text-blue-700 mt-1">
                                As a regular admin, you can only see and manage employees that you created. Statistics below reflect only your data.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">Admin</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $stats['approved_leaves_today'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        @if(auth()->user()->isSuperAdmin())
                            <a href="{{ route('admin.admins.create') }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 active:bg-purple-900 focus:outline-none focus:border-purple-900 focus:ring ring-purple-300 disabled:opacity-25 transition ease-in-out duration-150">
                        ...
                        <a href="{{ route('admin.reports') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:ring ring-blue-200 active:text-gray-800 active:bg-gray-50 disabled:opacity-25 transition ease-in-out duration-150">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-gray-900">
                            Recent Leave Requests
                            @if(auth()->user()->isRegularAdmin())
                                <span class="text-sm font-normal text-gray-500">(from your employees)</span>
                            @endif
                        </h3>
                        <a href="{{ route('admin.leaves.index') }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">View all</a>
                    </div>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">No recent leave requests</h3>
                            <p class="mt-1 text-sm text-gray-500">
                                @if(auth()->user()->isRegularAdmin())
                                    Your employees haven't submitted any leave requests yet.
                                @else
