            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600">Manage employee accounts and their information.</p>
                    </div>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    Used: {{ $employee->getTotalLeaveDaysThisYear() }}/12 days
                                                </div>
                                                <div class="text-sm text-gray-500">
                                                    Remaining: {{ $employee->getRemainingLeaveDays() }} days
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <form action="{{ route('admin.employees.destroy', $employee) }}" 
                                                          method="POST" 
                                                          class="inline"
                                                          onsubmit="return confirm('Are you sure you want to delete this employee? This will also delete all their leave records.')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" 
