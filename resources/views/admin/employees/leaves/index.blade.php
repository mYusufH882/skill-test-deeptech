    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('employee.leaves.create') }}" 
               class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg transition duration-150 ease-in-out">
                Request New Leave
            </a>
        </div>
    </x-slot>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $leaves->total() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <p class="text-sm font-medium text-gray-500">Days Used This Year</p>
                                <p class="text-2xl font-semibold text-gray-900">{{ auth()->user()->employee->getTotalLeaveDaysThisYear() }}/12</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <p class="text-sm font-medium text-gray-500">Remaining Days</p>
                                <p class="text-2xl font-semibold text-gray-900">{{ auth()->user()->employee->getRemainingLeaveDays() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600">Track all your leave requests and their approval status.</p>
                    </div>
                                    ...
                                    @foreach($leaves as $leave)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @if($leave->status !== 'pending' && $leave->admin_notes)
