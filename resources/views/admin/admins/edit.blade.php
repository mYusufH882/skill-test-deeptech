        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        <h3 class="text-lg font-medium text-gray-900">Update Admin Information</h3>
                        <p class="mt-1 text-sm text-gray-600">Modify the admin details below. Leave password fields blank to keep current password.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.admins.update', $admin) }}" class="space-y-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm text-gray-600">
                                <div>
                                    <span class="font-medium">Created:</span> {{ $admin->created_at->format('M d, Y \a\t g:i A') }}
                                </div>
                                <div>
                                    <span class="font-medium">Last Updated:</span> {{ $admin->updated_at->format('M d, Y \a\t g:i A') }}
                                </div>
                            </div>
                        </div>
